...
if(isset($_POST['buy'])){
  $query="INSERT INTO `raj14`(`sno`, `product`, `	Quantity`) VALUES ('1','$pname','3')";
    ...
    <body>
      <nav class="navbar navbar-expand-lg navbar-light bg-light py-3 fixed-top">
        ...
        <section id="featured" class="my-5 py-5" >
          ...
          <div onclick="window.location.href='sproduct.php';" class="row f-pro" >
            <div onclick="window.location.href='sproduct.php';" class="products text-center col-lg-3 col-md-4 col-12">
              ...
              <input type="text" name="pname" value="sports shoes">
              
              <h4 class="p-price">2555RS</h4>
              <button class="buy-btn" name="buy">Buy Now</button>
            </div>
